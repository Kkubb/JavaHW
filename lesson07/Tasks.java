...
public class Tasks {
    public static void main(String[] args) {
        System.out.println(teaPartyOne(6, 8));
        System.out.println(teaPartyOne(3, 8));
        System.out.println(teaPartyOne(20, 6));
    }

        public static int teaPartyOne(int tea, int candy){
        if (tea < 5 || candy <5) {
            return 0;
